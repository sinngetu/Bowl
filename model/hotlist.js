...
const table = () => db('work_hotlist')

exports.saveList = async (data) => data.length ? await table().insert(data) : []
exports.getList = {
    ...
    ByPlatform: async (platform) => platform ? await table().whereLike('platform', platform).select('*') : [],
